...
{
	private static final ResourceLocation normaldouble1 = new ResourceLocation("lightningmats:textures/entity/chest/TileEntityLightningChest1.png");
    private static final ResourceLocation christmas1 = new ResourceLocation("textures/entity/chest/christmas_double.png");
    private static final ResourceLocation normaldouble = new ResourceLocation("lightningmats:textures/entity/chest/TileEntityLightningChest1.png");
    private static final ResourceLocation normal1 = new ResourceLocation("lightningmats:textures/entity/chest/TileEntityLightningChest.png");
    private static final ResourceLocation christmas = new ResourceLocation("textures/entity/chest/christmas.png");
    private static final ResourceLocation normal = new ResourceLocation("lightningmats:textures/entity/chest/TileEntityLightningChest.png");
    ...
    public void renderTileEntityAt(TileEntityLightningChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        int i;
        ...
        if (p_147500_1_.adjacentChestZNeg == null && p_147500_1_.adjacentChestXNeg == null)
        {
            ...
            else
            {
                ...
                if (p_147500_1_.func_145980_j() == 1)
                {
                    this.bindTexture(normaldouble1);
                }
                else if (this.field_147509_j)
                {
                    this.bindTexture(christmas1);
                }
                else
                {
                    this.bindTexture(normaldouble);
                }
            }
    ...
    {
        this.renderTileEntityAt((TileEntityLightningChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}