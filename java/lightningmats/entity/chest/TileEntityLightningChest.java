...
public class TileEntityLightningChest extends TileEntity implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[72];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityLightningChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityLightningChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityLightningChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityLightningChest adjacentChestZPos;
    ...
    public TileEntityLightningChest()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityLightningChest(int p_i2350_1_)
    {
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "Lightning Chest";
    }
    ...
    private void func_145978_a(TileEntityLightningChest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityLightningChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityLightningChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityLightningChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityLightningChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
