...
public class ContainerSolar2 extends Container implements IProgressProvider
	{
		private TileEntitySolar2 macerator;
		private int lastCookTime;
		private int lastBurnTime;

		public ContainerSolar2(InventoryPlayer par1InventoryPlayer, TileEntitySolar2 par2TileEntityFurnace)
		{
		...
		public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
		{
			...
			if (slot != null && slot.getHasStack())
			{
				...
				else if (par2 != 1 && par2 != 0)
				{
					...
					else if (TileEntitySolar2.isItemFuel(itemstack1))
					{
