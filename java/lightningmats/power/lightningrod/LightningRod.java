package lightningmats.power.lightningrod;
...
public class LightningRod extends BlockContainer{
		...
		public LightningRod(int id, boolean isActive) {
			super(Material.rock);
		...
		public void registerBlockIcons(IIconRegister iconRegister){
			this.blockIcon = iconRegister.registerIcon("lightningmats" + ":" + "lightning");
			this.maceratorIconTop =  iconRegister.registerIcon("lightningmats" + ":" + (this.isActive ? "lightning" : "lightning"));
		}
		...
		{
			return LightningMaterials.LightningRod;
		}   
		...
		public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
		{
			...
			if (par0)
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.LightningRod);
			}
			else
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.LightningRod);
		...
		public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
		{
			...
			{
				((TileEntityLightningRod)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
			}
		}
		...
		public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
		{
			...
			{
				TileEntityLightningRod TileEntityLightningRod = (TileEntityLightningRod)par1World.getTileEntity(par2, par3, par4);

				if (TileEntityLightningRod != null)
				{
					for (int j1 = 0; j1 < TileEntityLightningRod.getSizeInventory(); ++j1)
					{
						ItemStack itemstack = TileEntityLightningRod.getStackInSlot(j1);
