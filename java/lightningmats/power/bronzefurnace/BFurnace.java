...
public class BFurnace extends BlockContainer{
		...
		{
			return Item.getItemFromBlock(LightningMaterials.BFurnace);
		}   
		...
		public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
			if(!world.isRemote) {
				FMLNetworkHandler.openGui(player, LightningMaterials.instance, LightningMaterials.guiIdBFurnace, world, x, y, z);
			}
		...
		public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
		{
			...
			if (par0)
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.BFurnaceActive);
			}
			else
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.BFurnace);
			}
		...
		{
			return LightningMaterials.BFurnace;
		}
