...
public class TileEntityCharger extends TileEntity implements ISidedInventory{
		...
		*/
    	...
    	{
        	return this.isInvNameLocalized() ? this.field_94130_e : "Charger";
    	}
    	...
    	public void updateEntity(){
        	...
        	this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;this.power--;
            	...
            	if (flag != this.power > 1000)
            	{
                	flag1 = true;
                		Macerator.updateFurnaceBlockState(this.power > 1000, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            		}
        	if (flag1){
            		this.closeInventory();}}
