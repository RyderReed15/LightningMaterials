...
public class GuiCharger extends BaseGui{
		public static final ResourceLocation texture = new ResourceLocation("lightningmats:textures/gui/macerator1.png");
		 
		final ContainerCharger m;
		public TileEntityCharger macerator;
		GuiProgressBar pb;
		public GuiCharger(InventoryPlayer invPlayer, TileEntityCharger entity) {
			super(new ContainerCharger(invPlayer, entity));
			m = (ContainerCharger) inventorySlots;
