...
public class Charger extends BlockContainer{
		...
		public Charger(int id, boolean isActive) {
			super(Material.rock);
		...
		public void registerBlockIcons(IIconRegister iconRegister){
			...
			this.maceratorIconTop =  iconRegister.registerIcon("lightningmats" + ":" + (this.isActive ? "macerator_front_lit1" : "macerator_front_idle1"));
		}
		...
		{
			return LightningMaterials.ChargerIdle;
		}   
		...
		public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
			if(!world.isRemote) {
				FMLNetworkHandler.openGui(player, LightningMaterials.instance, LightningMaterials.guiIdCharger, world, x, y, z);
			}
		...
		public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
		{
			...
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.ChargerActive);
			}
			else
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.ChargerIdle);
			}
		...
		public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
		{
			...
			{
				((TileEntityCharger)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
			}
		}
