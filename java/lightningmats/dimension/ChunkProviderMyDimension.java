package lightningmats.dimension;
...
//
//public class ChunkProviderMyDimension implements IChunkProvider
//{
//    /** RNG. */
//    private Random rand;
//
...
//    }
//
//    public ChunkProviderMyDimension(World par1World, long par2, boolean par4)
//    {
...
//                                if ((d16 += d15) > 0.0D)
//                                {
//                                    par3ArrayOfByte[j2 += short1] = (Block)Blocks.stone;
//                                }
//                                else if (k1 * 8 + l1 < b2)
//                                {
//                                    par3ArrayOfByte[j2 += short1] = (Block)Blocks.water;
//                                }
//                                else
//                                {
...
//     */
//    public void replaceBlocksForBiome(int par1, int par2, Block[] abyte2, BiomeGenBase[] par4ArrayOfBiomeGenBase)
//    {
//        ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, par1, par2, abyte2, par4ArrayOfBiomeGenBase);
...
//                float f = biomegenbase.getFloatTemperature(l, l, l);
...
//                    {
//                        abyte2[l1] = ((Block)Blocks.bedrock);
//                    }
//                    else
//                    {
//                    	Block b3 = abyte2[l1];
...
//        {
//            this.mineshaftGenerator.func_151539_a(this, this.worldObj, par1, par2, abyte);
//            this.villageGenerator.func_151539_a(this, this.worldObj, par1, par2, abyte);
//            this.strongholdGenerator.func_151539_a(this, this.worldObj, par1, par2, abyte);
//            
//        }
//
...
//        MinecraftForge.EVENT_BUS.post(event);
//        if (event.getResult() == cpw.mods.fml.common.eventhandler.Event.Result.DENY) return event.noisefield;
//
...
//                }
//
//                if (this.worldObj.isBlockHighHumidity(k1 + k, i2, l1 + l))
//                {
...
//        return biomegenbase == null ? null : (par1EnumCreatureType == EnumCreatureType.monster ? biomegenbase.getSpawnableList(par1EnumCreatureType):biomegenbase.getSpawnableList(par1EnumCreatureType));
//    }
//
//    /**
