...
//
//public class MyDimension1 extends Teleporter
//{
...
//
//    public MyDimension1(WorldServer par1WorldServer)
//    {
...
//                        int i2 = k + i1 * b1 - l * b0;
//                        boolean flag = j1 < 0;
//                        this.worldServerInstance.setBlock(k1, l1, i2, (Block) (flag ? Blocks.gold_block : 0));
//                    }
//                }
//            }
//
...
//
//                                        if (l3 < 0 && !( this.worldServerInstance.isAirBlock(k4, j4, l4)) || l3 >= 0 && !this.worldServerInstance.isAirBlock(k4, j4, l4))
//                                        {
//                                            continue label274;
//                                        }
//                                    }
...
//                                        j4 = j2 + (j3 - 1) * k3;
//
//                                        if (i4 < 0 && !this.worldServerInstance.isAirBlock(l3, k4, j4) || i4 >= 0 && !this.worldServerInstance.isAirBlock(l3, k4, j4))
//                                        {
//                                            continue label222;
//                                        }
//                                    }
