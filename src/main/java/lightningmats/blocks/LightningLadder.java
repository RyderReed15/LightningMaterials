...
public class LightningLadder extends Block
{
    private static final String __OBFID = "CL_00000262";

    public LightningLadder()
    {
    ...
    public void onEntityCollidedWithBlock(World world, int par2, int par3, int par4, Entity entity){
    	final float movement = 0.2f;
    	if (entity.motionY>=0.1){
    		entity.setPosition(entity.posX, entity.posY + movement, entity.posZ);
    	}
    }
}