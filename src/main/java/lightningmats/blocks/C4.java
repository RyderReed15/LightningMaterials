...
import lightningmats.entity.C4Entity;
...
public class C4 extends Block
{
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
            C4Entity C4Entity = new C4Entity(p_149723_1_, (double)((float)p_149723_2_ + 0.5F), (double)((float)p_149723_3_ + 0.5F), (double)((float)p_149723_4_ + 0.5F), p_149723_5_.getExplosivePlacedBy());
            C4Entity.fuse = p_149723_1_.rand.nextInt(C4Entity.fuse / 4) + C4Entity.fuse / 8;
            p_149723_1_.spawnEntityInWorld(C4Entity);
        }
    }
    ...
    public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.isRemote)
        {
            if ((p_150114_5_ & 1) == 1)
            {
                C4Entity C4Entity = new C4Entity(p_150114_1_, (double)((float)p_150114_2_ + 0.5F), (double)((float)p_150114_3_ + 0.5F), (double)((float)p_150114_4_ + 0.5F), p_150114_6_);
                p_150114_1_.spawnEntityInWorld(C4Entity);
                p_150114_1_.playSoundAtEntity(C4Entity, "game.tnt.primed", 1.0F, 1.0F);
            }
        }
    }
    ...
    {
        if (p_149727_5_.getCurrentEquippedItem() != null && p_149727_5_.getCurrentEquippedItem().getItem() == LightningMaterials.Detonater)
        {
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(this.texturePath + "side");
        this.field_150116_a = p_149651_1_.registerIcon(this.texturePath + "top");
        this.field_150115_b = p_149651_1_.registerIcon(this.texturePath + "bottom");
    }
}