...
public class LightningChest extends BlockContainer
{
    private final Random field_149955_b = new Random();
    public final int field_149956_a;
    private static final String __OBFID = "CL_00000214";

    public LightningChest(int p_i45397_1_)
    {
        super(Material.wood);
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityLightningChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityLightningChest TileEntityChest1 = (TileEntityLightningChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);

        if (TileEntityChest1 != null)
        {
            TileEntityChest1.updateContainingBlockInfo();
        }
    }

    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        TileEntityLightningChest TileEntityChest1 = (TileEntityLightningChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

        if (TileEntityChest1 != null)
        {
            for (int i1 = 0; i1 < TileEntityChest1.getSizeInventory(); ++i1)
            {
                ItemStack itemstack = TileEntityChest1.getStackInSlot(i1);
    ...
    {
        Object object = (TileEntityLightningChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
    ...
    {
        TileEntityLightningChest TileEntityChest1 = new TileEntityLightningChest();
        return TileEntityChest1;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = ((TileEntityLightningChest)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
