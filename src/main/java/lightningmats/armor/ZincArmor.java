...
public class ZincArmor extends ItemArmor {
	...
	public ZincArmor(int par1, ArmorMaterial par2EnumArmorMaterial, int par3,
	...
	private void SetArmorType(String myArmorName, int par4) {
		switch (par4) {
		case 0:		
			this.name = "ZincHelmet";
			this.setUnlocalizedName("ZincHelmet");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (this.name);
			break;
		case 1:
			this.name = "ZincChestplate";
			this.setUnlocalizedName("ZincChestplate");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (this.name);
			break;
		case 2:
			this.name = "ZincLeggings";
			this.setUnlocalizedName("ZincLeggings");
			this.texturePath += myArmorName + "_2.png";
			this.iconPath += (this.name);
			break;
		case 3:
			this.name = "ZincBoots";
			this.setUnlocalizedName("ZincBoots");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (name);
			break;
		}
