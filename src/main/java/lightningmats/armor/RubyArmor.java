...
public class RubyArmor extends ItemArmor {
	...
	private void SetArmorType(String myArmorName, int par4) {
		switch (par4) {
		case 0:		
			this.name = "RubyHelmet";
			this.setUnlocalizedName("RubyHelmet");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (this.name);
			break;
		case 1:
			this.name = "RubyChestplate";
			this.setUnlocalizedName("RubyChestplate");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (this.name);
			break;
		case 2:
			this.name = "RubyLeggings";
			this.setUnlocalizedName("RubyLeggings");
