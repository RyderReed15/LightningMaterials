...
public class SapphireArmor extends ItemArmor {
	...
	public SapphireArmor(int par1, ArmorMaterial par2EnumArmorMaterial, int par3,
	...
	private void SetArmorType(String myArmorName, int par4) {
		switch (par4) {
		case 0:		
			this.name = "SapphireHelmet";
			this.setUnlocalizedName("SapphireHelmet");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (this.name);
			break;
		case 1:
			this.name = "SapphireChestplate";
			this.setUnlocalizedName("SapphireChestplate");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (this.name);
			break;
		case 2:
			this.name = "SapphireLeggings";
			this.setUnlocalizedName("SapphireLeggings");
			this.texturePath += myArmorName + "_2.png";
			this.iconPath += (this.name);
			break;
		case 3:
			this.name = "SapphireBoots";
			this.setUnlocalizedName("SapphireBoots");
			this.texturePath += myArmorName + "_1.png";
			this.iconPath += (name);
			break;
		}
