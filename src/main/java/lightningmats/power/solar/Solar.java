...
public class Solar extends BlockContainer{
		...
		public Solar(int id, boolean isActive) {
			super(Material.rock);
		...
		public void registerBlockIcons(IIconRegister iconRegister){
			...
			this.maceratorIconTop =  iconRegister.registerIcon("lightningmats" + ":" + (this.isActive ? "macerator_side" : "macerator_side"));
		...
		{
			return (IIcon)(par1 == 1 ? this.Solarpaneltop : (par1 == 0 ? this.blockIcon : (par1 != par2 ? this.blockIcon : this.maceratorIconTop)));
		}
		...
		{
			return LightningMaterials.SolarIdle;
		}   
		...
		public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
		{
			...
			if (par0)
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.SolarActive);
			}
			else
			{
				par1World.setBlock(par2, par3, par4, LightningMaterials.SolarIdle);
			}
		...
		public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
		{
			...
			{
				((TileEntitySolar)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
			}
		}
		...
		public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
		{
			...
			{
				TileEntitySolar TileEntitySolar = (TileEntitySolar)par1World.getTileEntity(par2, par3, par4);
