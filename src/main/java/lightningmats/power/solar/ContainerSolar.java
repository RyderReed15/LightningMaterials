...
public class ContainerSolar extends Container implements IProgressProvider
	{
		private TileEntitySolar macerator;
		private int lastCookTime;
		private int lastBurnTime;

		public ContainerSolar(InventoryPlayer par1InventoryPlayer, TileEntitySolar par2TileEntityFurnace)
		{
		...
		public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
		{
			...
			if (slot != null && slot.getHasStack())
			{
				...
				else if (par2 != 1 && par2 != 0)
				{
					...
					else if (TileEntitySolar.isItemFuel(itemstack1))
					{
