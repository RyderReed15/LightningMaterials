...
public class ContainerNickelFurnace extends Container implements IProgressProvider
	{
		...
		public void addCraftingToCrafters(ICrafting par1ICrafting)
		{
			...
			par1ICrafting.sendProgressBarUpdate(this, 2, this.macerator.cookTime2);
			par1ICrafting.sendProgressBarUpdate(this, 3, this.macerator.cookTime1);
		}
		...
		public void detectAndSendChanges()
		{
			...
			for (int i = 0; i < this.crafters.size(); ++i)
			{
				...
				if (this.lastCookTime2 != this.macerator.cookTime2)
				{
					icrafting.sendProgressBarUpdate(this, 2, this.macerator.cookTime2);
				}
				if (this.lastCookTime1 != this.macerator.cookTime1)
				{
					icrafting.sendProgressBarUpdate(this, 3, this.macerator.cookTime1);
				}
			...
			this.lastCookTime1 = this.macerator.cookTime1;
			this.lastCookTime2 = this.macerator.cookTime2;
		...
		public void updateProgressBar(int par1, int par2)
		{
			...
			if (par1 == 2)
			{
				this.macerator.cookTime2 = par2;
			}
			if (par1 == 3)
			{
				this.macerator.cookTime1 = par2;
			}
